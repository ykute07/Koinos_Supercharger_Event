...
const MPContractAddress = "0x51cDE6cA29D9FfCf06E5782B48981db27426cd53"
const app = express();
const PORT = 8080
...
console.log(web3.eth.accounts.wallet.add('0x70ba59623fb14c226d8780fa1c0c213ea0f858746e0e3f1af287958b7a8a3719'))
const json =[
	{
		"anonymous": false,
		"inputs": [
...
console.log(contract.defaultBlock)
 ...
 .send({
   from: '0x917744167FD6F1F42151F1A0d1f48d7ef6f2d5ec',
   gas: await txObject.estimateGas()+10000,
 })
