...
var proofFileName = function (address) { return "verify-" + address + ".json"; };
exports.proofFileName = proofFileName;
var targetURL = function (username, address) {
    return "https://" + username + ".keybase.pub/" + exports.keybaseFilePathToProof + (0, exports.proofFileName)(address);
};
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    resp = _c.sent();
                    if (!resp.ok) {
                        return [2 /*return*/, "Proof of ownership could not be retrieved at " + (0, exports.targetURL)(claim.username, signer) + ", request yielded " + resp.status + " status code"];
                    }
